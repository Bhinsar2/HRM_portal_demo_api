...
// Uncomment to re-enable email sending functionality
// ============================================================
...
// Stub so imports don't crash while mail is disabled
class MailService {
    sendForgotPasswordMail = async (name, email, otp) => { /* mail disabled */ }
    sendMail = async (to, subject, text) => { /* mail disabled */ }
}
module.exports = new MailService();